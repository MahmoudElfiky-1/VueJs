  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr; background-color: #161b26; border-radius: 16px; overflow: hidden; border: 1px solid #1e2736;">
    ...
    <div style="padding: 1.5rem;">
      <img
        :src="product.image"
        :alt="product.name"
        style="width: 100%; height: 420px; object-fit: cover; border-radius: 12px; display: block;"
      />
    </div>
    ...
    <div style="padding: 2rem; display: flex; flex-direction: column; justify-content: center;">
      ...
      <!-- Name -->
      <h1 style="font-size: 2rem; font-weight: bold; color: white; margin: 0 0 0.8rem 0;">
        {{ product.name }}
      </h1>

      <!-- Description -->
      <p style="color: #8892a4; font-size: 1rem; line-height: 1.6; margin: 0 0 1.2rem 0;">
        {{ product.description }}
      </p>
      ...
      <div style="display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 1.2rem;">
        <span
          ...
          :key="index"
          style="padding: 0.3rem 0.7rem; border: 1px solid #6366f1; border-radius: 6px; color: #6366f1; font-size: 0.8rem; font-weight: 500;"
        >
          #{{ tag }}
        </span>
      </div>
      ...
      <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.2rem;">
        <div style="display: flex; align-items: center; gap: 10px;">
          <span style="font-size: 1.8rem; font-weight: bold; color: white;">
            ${{ discountedPrice.toFixed(2) }}
          </span>

          <span
            v-if="product.discount > 0"
            style="text-decoration: line-through; color: #555; font-size: 1rem;"
          >
        ...
        <span
          :style="{
            ...
            border: product.stock > 0 ? '1px solid #22c55e' : '1px solid #ef4444'
          }"
        >
      ...
      <button
        ...
        :style="{
          ...
          color: 'white',
          backgroundColor: product.stock > 0 ? '#6366f1' : '#333',
